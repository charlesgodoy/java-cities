...
public class JavaCitiesApplication {
    ...
    public static final String QUEUE_CITY1 = "Cities1PriorityQueue";
    public static final String QUEUE_CITY2 = "Cities2PriorityQueue";
    public static final String QUEUE_SECRET = "SecretPriorityQueue";
    ...
    {
        return BindingBuilder.bind(appQueueCities1()).to(appExchange()).with(QUEUE_CITY1);
    }
    ...
    {
        return BindingBuilder.bind(appQueueCities2()).to(appExchange()).with(QUEUE_CITY2);
    }
